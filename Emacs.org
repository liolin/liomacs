...
#+begin_src emacs-lisp
  (use-package mu4e
    ...
    (mu4e-maildir "~/.mail/olivier.lischer@liolin.ch")
    ...
    (mu4e-refile-folder
     (lambda (msg)
       (cond
        ...
        ((mu4e-message-contact-field-matches msg :from
                                             "bitpanda")
         "/Archive/bill/bitpanda")
        ((mu4e-message-contact-field-matches msg :from
                                             "brack")
         "/Archive/bill/brack")
        ((mu4e-message-contact-field-matches msg :from
                                             "exlibris")
         "/Archive/bill/exlibris")

        ((or (mu4e-message-contact-field-matches msg :from
                                                 "galaxus")
             (mu4e-message-contact-field-matches msg :from
                                                 "digitec"))
         "/Archive/bill/galaxus")
        ((mu4e-message-contact-field-matches msg :from
                                             "mootes")
         "/Archive/bill/mootes")
        ((mu4e-message-contact-field-matches msg :from
                                             "musicnotes")
         "/Archive/bill/musicnotes")
        ((or (mu4e-message-contact-field-matches msg :from
                                                 "sbb")
             (mu4e-message-contact-field-matches msg :from
                                                 "swisspass"))
