;; Base16 Gruvbox dark, hard (https://github.com/chriskempson/base16)
;; Scheme: Dawid Kurek (dawikur@gmail.com), morhetz (https://github.com/morhetz/gruvbox)

;;; base16-gruvbox-dark-hard-dark-theme.el
...
(let* ((base00 "#1d2021")
       ...
       (ol4 `(:height 1.0 :weight bold :slant normal :foreground ,base08))
...
(provide-theme 'base16-gruvbox-dark-hard-dark)

;;; base16-gruvbox-dark-hard-dark-theme.el ends here
